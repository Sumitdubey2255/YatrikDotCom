...
<?php require('enquiry_btn.php'); ?>
    ...
    <section class="desc">
        <div class="box">
            ...
            <h3>The land that many dream to experience is India’s Crown & Earth’s Paradise, indeed!</h3>
            <p>Rightly known as the ‘Crown of India’, the state of Jammu & Kashmir indeed lives up to its nickname of being the ‘Paradise on Earth’. As quoted by the Mughal Emperor Jehangir, “If there is a heaven on earth, it's here, it's here, it's here”, Jammu & Kashmir casts a spell on everyone who visits here. It’s a dream of every Indian traveller to visit this paradise, at least once a lifetime. A holiday destination for every reason and for every season is this land that inspired poets for centuries.
            <div class="content">
                Enchanting Chinar trees, bewitching thick deodar forests, beautiful apple orchards, stunning saffron fields, majestic snow-clad mountains, adorable Shikaras, iconic Houseboats, colourful Tulips in spring, spectacular snow-heaven Gulmarg, stunning Solang, and the list is never ending. Jammu & Kashmir is the break you need. Explore the paradise’s unique attributes and experience their traditions and cultures like your own! Browse the beauty of Jammu & Kashmir along with all of our proficient Veena World online tour packages. Veena World encourages you to make the most fascinating memories with us and relish our legacy to travel, explore and celebrate life. Jammu and Kashmir is the northernmost Indian province, often dubbed as the crown of India. The state is located in the western foothills of the mighty Himalayan range
            </div>
            ...
            <div class="container">
                ...
                <ul class="package-list">
                    <li>
                        <div class="package-card">
                            <figure class="card-banner">
                                <img src="../images/kashmir3.jpg" alt="Experience Great Holiday in kashmir" loading="lazy">
                            </figure>

                            <div class="card-content">
                                <h3 class="h3 card-title">Experience Great Holiday in Highlights of Kashmir
                                </h3>
                                <p class="card-text">
                    ...
                    <li>
                        <div class="package-card">
                            <figure class="card-banner">
                                <img src="../images/kashmir5.jpg" alt="Honeymoon Special Kashmir" loading="lazy">
                            </figure>

                            <div class="card-content">
                                <h3 class="h3 card-title">Honeymoon Special Kashmir</h3>
                                <p class="card-text">
                                    The land that many dream to experience is India’s Crown & Earth’s Paradise, indeed!
                                </p>
                    ...
                    <li>
                        <div class="package-card">
                            <figure class="card-banner">
                                <img src="../images/vaishno-devi.jpg" alt="Experience Great Holiday in kashmir" loading="lazy">
                            </figure>

                            <div class="card-content">
                                <h3 class="h3 card-title">Kashmir Vaishnodevi</h3>
                                <p class="card-text">
                                    The land that many dream to experience is India’s Crown & Earth’s Paradise, indeed!
                                </p>
                    ...
                    <li>
                        <div class="package-card">
                            <figure class="card-banner">
                                <img src="../images/Leh-ladakh.jpg" alt="Experience Great Holiday in Russia" loading="lazy">
                            </figure>

                            <div class="card-content">
                                <h3 class="h3 card-title">Leh Ladakh Kargil Kashmir</h3>
                                <p class="card-text">
                                    The land that many dream to experience is India’s Crown & Earth’s Paradise, indeed!
                                </p>
